...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shader/conservative.vert.glsl", &vertexSource);
    glusFileLoadText("shader/conservative.geom.glsl", &geometrySource);
    glusFileLoadText("shader/conservative.frag.glsl", &fragmentSource);

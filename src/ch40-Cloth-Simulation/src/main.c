...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shader/cloth.comp.glsl", &computeSource);
    ...
    glusFileLoadText("shader/cloth.vert.glsl", &vertexSource);
    glusFileLoadText("shader/cloth.frag.glsl", &fragmentSource);

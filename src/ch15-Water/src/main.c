...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shader/Water.vert.glsl", &vertexSource);
    glusFileLoadText("shader/Water.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/water_pos_x.tga", &image);
    ...
    glusImageLoadTga("../../media/water_neg_x.tga", &image);
    ...
    glusImageLoadTga("../../media/water_pos_y.tga", &image);
    ...
    glusImageLoadTga("../../media/water_neg_y.tga", &image);
    ...
    glusImageLoadTga("../../media/water_pos_z.tga", &image);
    ...
    glusImageLoadTga("../../media/water_neg_z.tga", &image);

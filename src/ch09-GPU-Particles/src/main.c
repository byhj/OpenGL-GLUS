...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shader/update_points.vert.glsl", &vertexSource);
    glusFileLoadText("shader/update_points.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("../../media/particle.tga", &image);
